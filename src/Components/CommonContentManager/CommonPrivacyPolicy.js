				...
				<div className='main py-5'>
					<div className='container'>
						<div className='about-section'>
							<h1 className='text-gray1 fs-30 medium pb-3 fs-30'>{t("Privacy Policy")}</h1>
							<span className='text-gray2 light text-justify'>
								<RenderHTMLstring htmlString={data?.privacy_policy} />
							</span>
						</div>
					</div>
				</div>
...
export default CommonPrivacyPolicy;
